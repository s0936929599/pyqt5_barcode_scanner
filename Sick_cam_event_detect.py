...
bRuning,bGet,frame,iRuning,sRunning= True ,False ,None,True,False
...
class MainWindow(QWidget):
    ...
    def bt_saveimage(self): # button trigger light and pyzbar
        global bRuning,image_s,iRuning,sRunning
    ...
    def thread_sick_cam(self):
        ...
        if self.ui.control_bt.text()=='Start':
            ...
            #while self.ui.control_bt.text()=='Stop' and sRunning:
            #    while bGet==False:time.sleep(0.001)
            #    print(time.time())
            #    bGet = False
            #    image = cv2.resize(frame,(640,480)).reshape((480,640,1))
    ...
    def sick_cam(self):
        ...
        if count==0:
            ...
            destPtr = None
            while bRuning:
                while dataStream.NumBuffersAwaitDelivery()<1:time.sleep(0.01)
